    ...
    return BottomNavigationBar(
      ...
      items: [
        ...
        const BottomNavigationBarItem(
            icon: Icon(Icons.mail_rounded), label: 'Request'),
          ...
          icon: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const Icon(
                    Icons.notifications_active); // Default icon while loading
              }

              if (snapshot.hasError) {
                return const Icon(Icons
                    .notifications_active); // Default icon if an error occurs
              }
              ...
              return const Icon(
                  Icons.notifications_active); // Default message icon
            },
          ),
          label: 'Notification',
        ),
